    ...
    struct ConnectionCommands {
        ...
        func clientList() async throws {
            try await testCommandEncodesDecodes(
                ...
                let result = try await connection.clientList()
                try Self.validateClientListResponse(result, expectedCount: 2)
        ...
        private static func validateClientListResponse(_ response: CLIENT.LIST.Response, expectedCount: Int) throws {
            ...
            #expect(try Int(client1[.id]!) == 3)
            #expect(try String(client1[.addr]!) == "127.0.0.1:52698")
            #expect(try String(client1[.laddr]!) == "127.0.0.1:6379")
            #expect(try Int(client1[.fd]!) == 8)
            #expect(try String(client1[.name]!) == "")
            #expect(try Int(client1[.age]!) == 5)
            #expect(try Int(client1[.idle]!) == 0)
            #expect(try String(client1[.flags]!) == "N")
            #expect(try Int(client1[.db]!) == 0)
            #expect(try Int(client1[.sub]!) == 0)
            #expect(try Int(client1[.psub]!) == 0)
            #expect(try Int(client1[.ssub]!) == 0)
            #expect(try Int(client1[.multi]!) == -1)
            #expect(try Int(client1[.qbuf]!) == 26)
            #expect(try Int(client1[.qbufFree]!) == 20448)
            #expect(try Int(client1[.argvMem]!) == 10)
            #expect(try Int(client1[.multiMem]!) == 0)
            #expect(try Int(client1[.obl]!) == 0)
            #expect(try Int(client1[.oll]!) == 0)
            #expect(try Int(client1[.omem]!) == 0)
            #expect(try Int(client1[.totMem]!) == 61466)
            #expect(try String(client1[.events]!) == "r")
            #expect(try String(client1[.cmd]!) == "client|list")
            #expect(try String(client1[.user]!) == "default")
            #expect(try Int(client1[.redir]!) == -1)
            #expect(try Int(client1[.resp]!) == 3)
            #expect(try String(client1[.libName]!) == "valkey-swift")
            #expect(try String(client1[.libVer]!) == "1.0.0")

            // Verify second client (client with id=5)
            let client2 = response.clients[1]
            #expect(try Int(client2[.id]!) == 5)
            #expect(try String(client2[.addr]!) == "127.0.0.1:52699")
            #expect(try String(client2[.laddr]!) == "127.0.0.1:6379")
            #expect(try Int(client2[.fd]!) == 9)
            #expect(try String(client2[.name]!) == "myconnection")
            #expect(try Int(client2[.age]!) == 3)
            #expect(try Int(client2[.idle]!) == 1)
            #expect(try String(client2[.flags]!) == "N")
            #expect(try Int(client2[.db]!) == 1)
            #expect(try Int(client2[.sub]!) == 0)
            #expect(try Int(client2[.psub]!) == 0)
            #expect(try Int(client2[.ssub]!) == 0)
            #expect(try Int(client2[.multi]!) == -1)
            #expect(try Int(client2[.qbuf]!) == 0)
            #expect(try Int(client2[.qbufFree]!) == 0)
            #expect(try Int(client2[.argvMem]!) == 0)
            #expect(try Int(client2[.multiMem]!) == 0)
            #expect(try Int(client2[.obl]!) == 0)
            #expect(try Int(client2[.oll]!) == 0)
            #expect(try Int(client2[.omem]!) == 0)
            #expect(try Int(client2[.totMem]!) == 20504)
            #expect(try String(client2[.events]!) == "r")
            #expect(try String(client2[.cmd]!) == "get")
            #expect(try String(client2[.user]!) == "default")
            #expect(try Int(client2[.redir]!) == -1)
            #expect(try Int(client2[.resp]!) == 3)
