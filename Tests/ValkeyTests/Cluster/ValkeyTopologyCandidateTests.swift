...
struct ValkeyTopologyCandidateTests {
    ...
    func ensureOrderDoesntMatter() throws {
        ...
        let candidate1 = try ValkeyTopologyCandidate(.init(description))
        let candidate2 = try ValkeyTopologyCandidate(.init(copy1))
    ...
    func twoPrimaryNodesForTheSameShardThrows() {
        ...
        #expect(throws: ValkeyClusterError.shardHasMultiplePrimaryNodes) { try ValkeyTopologyCandidate(.init(description)) }
    }
    ...
    func noPrimaryNodeForAShardThrows() {
        ...
        #expect(throws: ValkeyClusterError.shardIsMissingPrimaryNode) { try ValkeyTopologyCandidate(.init(description)) }
    }
    ...
    func failoverWithOneFailedAndOneOnlinePrimarySucceeds() throws {
        ...
        let candidate = try ValkeyTopologyCandidate(.init(description))
