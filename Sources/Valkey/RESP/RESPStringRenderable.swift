...
/// A type that the command encoder can render as a single string in a Valkey command.
...
@usableFromInline
package struct RESPRenderableBulkString<Value: RESPStringRenderable>: RESPRenderable {
    @usableFromInline
