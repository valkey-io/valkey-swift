...
extension ValkeyClientProtocol {
    ...
    /// - Response: The number of active failure reports for the node.
    @inlinable
    @discardableResult
    ...
    /// - Available: 3.0.0
    /// - Complexity: O(1)
    /// - Response: The number of keys in the specified hash slot.
    @inlinable
    @discardableResult
    ...
    /// - Response: An array with up to count elements.
    @inlinable
    @discardableResult
    ...
    /// - Response: A nested list of maps, one for each migration, with keys and values representing migration fields.
    @inlinable
    @discardableResult
    ...
    /// - Available: 3.0.0
    /// - Complexity: O(1)
    /// - Response: A map between named fields and values in the form of <field>:<value> lines separated by newlines composed by the two bytes CRLF
    @inlinable
    @discardableResult
    ...
    /// - Response: The hash slot number for the specified key
    @inlinable
    @discardableResult
    ...
    /// - Response: An array of cluster links and their attributes.
    @inlinable
    @discardableResult
    ...
    /// - Available: 3.0.0
    /// - Complexity: O(N) where N is the total number of Cluster nodes
    /// - Response: The serialized cluster configuration.
    @inlinable
    @discardableResult
    ...
    /// - Response: A list of replica nodes replicating from the specified primary node provided in the same format used by CLUSTER NODES.
    @inlinable
    @discardableResult
    ...
    /// - Available: 7.0.0
    /// - Complexity: O(N) where N is the total number of cluster nodes
    /// - Response: A nested list of a map of hash ranges and shard nodes describing individual shards.
    @inlinable
    @discardableResult
    ...
    /// - Response: Array of nested arrays, where the inner array element represents a slot and its respective usage statistics.
    @inlinable
    @discardableResult
    ...
    /// - Complexity: O(N) where N is the total number of Cluster nodes
    /// - Response: Nested list of slot ranges with networking information.
    @inlinable
    @discardableResult
