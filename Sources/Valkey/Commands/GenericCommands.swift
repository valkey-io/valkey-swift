...
extension ValkeyClientProtocol {
    ...
    /// - Response: Number of keys that exist from those specified as arguments.
    @inlinable
    ...
    /// - Response: List of keys matching pattern.
    @inlinable
    ...
    /// - Available: 2.2.3
    /// - Complexity: O(1)
    /// - Response: The idle time in seconds.
    @inlinable
    ...
    /// - Available: 2.2.3
    /// - Complexity: O(1)
    /// - Response: The number of references.
    @inlinable
    ...
    /// - Available: 7.0.0
    /// - Complexity: O(N+M*log(M)) where N is the number of elements in the list or set to sort, and M the number of returned elements. When the elements are not sorted, complexity is O(N).
    /// - Response: A list of sorted elements.
    @inlinable
    public func sortRo(
        _ key: ValkeyKey,
        byPattern: String? = nil,
    ...
    /// - Response: The number of touched keys.
    @inlinable
    ...
    /// - Response: The number of keys that were unlinked.
    @inlinable
    @discardableResult
    ...
    /// - Available: 3.0.0
    /// - Complexity: O(1)
    /// - Response: The number of replicas reached by all the writes performed in the context of the current connection.
    @inlinable
    @discardableResult
