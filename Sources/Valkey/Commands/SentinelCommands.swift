...
extension ValkeyClientProtocol {
    ...
    /// - Available: 2.8.4
    /// - Response: Returns OK if the current Sentinel configuration is able to reach the quorum needed to failover a primary, and the majority needed to authorize the failover.
    @inlinable
    @discardableResult
    ...
    @inlinable
    @discardableResult
    public func sentinelConfig(action: SENTINEL.CONFIG.Action) async throws(ValkeyClientError) -> RESPToken.Map? {
    ...
    /// - Response: This is actually a map, the odd entries are a primary name, and the even entries are the last cached INFO output from that primary and all its replicas.
    @inlinable
    @discardableResult
    ...
    /// - Complexity: O(1)
    /// - Response: The state and info of the specified primary.
    @inlinable
    @discardableResult
    ...
    /// - Response: List of monitored primaries, and their states.
    @inlinable
    @discardableResult
    ...
    /// - Complexity: O(1)
    @inlinable
    public func sentinelMonitor<Name: RESPStringRenderable, Ip: RESPStringRenderable>(
        name: Name,
        ip: Ip,
        port: Int,
        quorum: Int
    ...
    /// - Available: 6.2.0
    /// - Complexity: O(1)
    /// - Response: Node ID of the sentinel instance.
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.8.4
    /// - Response: List of pending scripts.
    @inlinable
    @discardableResult
    ...
    /// - Complexity: O(1)
    @inlinable
    public func sentinelRemove<PrimaryName: RESPStringRenderable>(primaryName: PrimaryName) async throws(ValkeyClientError) {
    ...
    /// - Response: List of replicas for this primary, and their state.
    @inlinable
    @discardableResult
    ...
    /// - Response: The number of primaries that were reset.
    @inlinable
    @discardableResult
    ...
    /// - Response: List of sentinel instances, and their state.
    @inlinable
    @discardableResult
    ...
    /// - Complexity: O(N) where N is the number of replicas.
    /// - Response: List of monitored replicas, and their state.
    @inlinable
    @discardableResult
