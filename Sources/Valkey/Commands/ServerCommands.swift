...
extension ValkeyClientProtocol {
    ...
    /// - Response: The number of users that were deleted.
    @inlinable
    @discardableResult
    ...
    /// - Available: 6.0.0
    /// - Complexity: O(1)
    /// - Response: Pseudorandom data. By default it contains 64 bytes, representing 256 bits of data. If `bits` was given, the output string length is the number of specified bits (rounded to the next multiple of 4) divided by 4.
    @inlinable
    @discardableResult
    ...
    /// - Available: 6.0.0
    /// - Complexity: O(1)
    /// - Response: A list of subcommands and their description.
    @inlinable
    @discardableResult
    ...
    /// - Response: A list of currently active ACL rules.
    @inlinable
    @discardableResult
    ...
    /// - Available: 6.0.0
    /// - Complexity: O(N). Where N is the number of configured users.
    /// - Response: List of existing ACL users.
    @inlinable
    @discardableResult
    ...
    /// - Available: 6.0.0
    /// - Complexity: O(1)
    /// - Response: The username of the current connection.
    @inlinable
    @discardableResult
    ...
    /// - Available: 1.0.0
    /// - Complexity: O(1)
    /// - Response: A simple string reply indicating that the rewriting started or is about to start ASAP
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.8.13
    /// - Complexity: O(1)
    /// - Response: Number of total commands in this server.
    @inlinable
    @discardableResult
    ...
    /// - Response: A map where each key is a command name, and each value is the documentary information
    @inlinable
    @discardableResult
    ...
    /// - Response: List of keys from the given command.
    @inlinable
    @discardableResult
    ...
    /// - Response: Entries from the command log in chronological order.
    @inlinable
    @discardableResult
    ...
    /// - Available: 8.1.0
    /// - Complexity: O(1)
    /// - Response: Number of entries in the command log.
    @inlinable
    @discardableResult
    ...
    /// - Available: 1.0.0
    /// - Complexity: O(1)
    /// - Response: The number of keys in the currently-selected database.
    @inlinable
    ...
    /// - Available: 1.0.0
    /// - Complexity: O(1)
    /// - Response: UNIX TIME of the last DB save executed with success.
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.8.13
    /// - Complexity: O(1)
    /// - Response: A human readable latency analysis report.
    @inlinable
    @discardableResult
    ...
    /// - Response: A map where each key is a command name, and each value is a map with the total calls, and an inner map of the histogram time buckets.
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.8.13
    /// - Complexity: O(1)
    /// - Response: An array where each element is a two elements array representing the timestamp and the latency of the event.
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.8.13
    /// - Complexity: O(1)
    /// - Response: An array where each element is an array representing the event name, timestamp, latest and all-time latency measurements.
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.8.13
    /// - Complexity: O(1)
    /// - Response: Number of event time series that were reset.
    @inlinable
    @discardableResult
    ...
    /// - Available: 5.0.0
    /// - Response: String containing the generative computer art, and a text with the server version.
    @inlinable
    ...
    /// - Available: 4.0.0
    /// - Complexity: O(1)
    /// - Response: Memory problems report.
    @inlinable
    @discardableResult
    ...
    /// - Response: The memory allocator's internal statistics report.
    @inlinable
    @discardableResult
    ...
    /// - Complexity: O(N) where N is the number of entries returned
    /// - Response: Entries from the slow log in chronological order.
    @inlinable
    @discardableResult
    ...
    /// - Available: 2.2.12
    /// - Complexity: O(1)
    /// - Response: Number of entries in the slow log.
    @inlinable
    @discardableResult
