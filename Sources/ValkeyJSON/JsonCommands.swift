...
extension ValkeyConnectionProtocol {
    ...
    @inlinable
    public func jsonArrappend<Path: RESPStringRenderable, Json: RESPStringRenderable>(key: ValkeyKey, path: Path, json: [Json]) async throws -> JSON.ARRAPPEND<Path, Json>.Response {
    ...
    @inlinable
    public func jsonArrindex<Path: RESPStringRenderable, JsonScalar: RESPStringRenderable>(key: ValkeyKey, path: Path, jsonScalar: JsonScalar, start: Int? = nil, end: Int? = nil) async throws -> JSON.ARRINDEX<Path, JsonScalar>.Response {
    ...
    /// - Complexity: O(N) where N is the length of the array.
    @inlinable
    public func jsonArrinsert<Path: RESPStringRenderable, Json: RESPStringRenderable>(key: ValkeyKey, path: Path, index: Int, json: [Json]) async throws -> JSON.ARRINSERT<Path, Json>.Response {
    ...
    @inlinable
    public func jsonArrtrim<Path: RESPStringRenderable>(key: ValkeyKey, path: Path, start: Int, end: Int) async throws -> JSON.ARRTRIM<Path>.Response {
    ...
    /// - Complexity: O(1)
    @inlinable
    public func jsonDebug<SubcommandArguments: RESPStringRenderable>(subcommandArguments: SubcommandArguments) async throws -> JSON.DEBUG<SubcommandArguments>.Response {
    ...
    @inlinable
    public func jsonMget<Path: RESPStringRenderable>(key: [ValkeyKey], path: Path) async throws -> JSON.MGET<Path>.Response {
    ...
    /// - Complexity: O(N) where N is the number of keys
    @inlinable
    public func jsonMset<Path: RESPStringRenderable, Json: RESPStringRenderable>(data: [JSON.MSET<Path, Json>.Data]) async throws -> JSON.MSET<Path, Json>.Response {
    ...
    /// - Complexity: O(N) where N is the number of json values matched by the path.
    @inlinable
    public func jsonNumincrby<Path: RESPStringRenderable>(key: ValkeyKey, path: Path, number: Int) async throws -> JSON.NUMINCRBY<Path>.Response {
    ...
    /// - Complexity: O(N) where N is the number of json values matched by the path.
    @inlinable
    public func jsonNummultby<Path: RESPStringRenderable>(key: ValkeyKey, path: Path, number: Int) async throws -> JSON.NUMMULTBY<Path>.Response {
    ...
    /// - Complexity: O(N) where N is the number of json values matched by the path.
    @inlinable
    public func jsonSet<Path: RESPStringRenderable, Json: RESPStringRenderable>(key: ValkeyKey, path: Path, json: Json, options: String? = nil) async throws -> JSON.SET<Path, Json>.Response {
    ...
    @inlinable
    public func jsonStrappend<JsonString: RESPStringRenderable>(key: ValkeyKey, path: String? = nil, jsonString: JsonString) async throws -> JSON.STRAPPEND<JsonString>.Response {
