...
var package = Package(
    ...
    traits: [
        ...
        .trait(name: "MetricsSupport"),
        .default(enabledTraits: ["ServiceLifecycleSupport", "DistributedTracingSupport", "MetricsSupport"]),
    ],
    dependencies: [
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "Metrics", package: "swift-metrics", condition: .when(traits: ["MetricsSupport"])),
        ...
        .testTarget(
            ...
            dependencies: [
                ...
                .product(name: "Logging", package: "swift-log"),
                .product(name: "Metrics", package: "swift-metrics", condition: .when(traits: ["MetricsSupport"])),
                .product(name: "MetricsTestKit", package: "swift-metrics", condition: .when(traits: ["MetricsSupport"])),
